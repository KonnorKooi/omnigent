...
export const PALETTES: readonly PaletteMeta[] = [
  {
    id: "omni",
    label: "Omnigent",
    blurb: "The signature forest green brand look.",
    light: {
      bg: "#f7fbf8",
      card: "#ffffff",
      accent: "#1f7a44",
    ...
    dark: { bg: "#0e1a13", card: "#1f2c24", accent: "#1f7a44", border: "#24332a", text: "#f4f5f7" },
    tokens: {
      light: paletteTokens({
        background: "#ffffff",
        foreground: "#27272a",
        ...
        sidebarRing: "#2272b4",
        sidebarActive: "rgba(31, 122, 68, 0.1)",
        sidebarActiveForeground: "#124c2b",
        sidebarBackground: "linear-gradient(90deg, #fffefe, #f6faf7)",
      ...
      dark: paletteTokens({
        ...
        sidebarActive: "rgba(31, 122, 68, 0.18)",
        sidebarActiveForeground: "#86efac",
        sidebarBackground:
          "linear-gradient(transparent 35%, rgba(34, 94, 60, 0.22)), linear-gradient(135deg, rgba(255, 255, 255, 0.04), transparent 60%)",
        shellBackground:
          "radial-gradient(rgba(34, 110, 66, 0.14), transparent 50%), radial-gradient(at 80% 20%, rgba(22, 88, 52, 0.1), transparent 45%), linear-gradient(145deg, #0f2419, #0e1418, #101a14)",
      }),
    },
  },
  {
